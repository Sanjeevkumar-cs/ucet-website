...
export const metadata = {
  ...
  description:
    "Explore our engineering programs including Computer Science, Mechanical, Electrical, and Civil Engineering.",
};
  ...
  const programs = [
    {
      ...
      icon: "💻",
      overview:
        "Master modern programming, software development, artificial intelligence, and cloud computing.",
      highlights: [
        "Machine Learning & AI",
        "Cloud Computing",
        "Web Development",
    ...
    },
    {
      ...
      icon: "⚙️",
      overview:
        "Learn mechanical design, manufacturing, thermodynamics, and industrial automation.",
      highlights: [
        "CAD & Modeling",
    ...
    },
    {
      ...
      icon: "⚡",
      overview:
        "Study power systems, electronics, control systems, and electrical machines.",
      highlights: [
        "Power Systems",
        "Electronics",
        "Control Systems",
    ...
    },
    {
      ...
      duration: "4 Years",
      icon: "💻", // Changed from crane to computer/laptop
      overview:
        "Focused on the study and application of computer systems, networking, and software for managing and processing data.",
      highlights: [
  ...
  const features = [
    {
      ...
      description:
        "Industry-aligned curriculum updated regularly to match current technological trends",
    },
    {
      icon: Users,
      title: "Expert Faculty",
      description:
        "Experienced educators and researchers with PhDs and industry experience",
    },
    {
      icon: Microscope,
      title: "Research Facilities",
      description:
        "State-of-the-art laboratories and research centers for hands-on learning",
    },
    {
      icon: Award,
    ...
    <div className="w-full">
      ...
      <section className="bg-gradient-to-br from-primary/10 via-accent/5 to-transparent py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-in">
          ...
          <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Comprehensive engineering education across diverse disciplines with
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`group bg-white border border-gray-200 rounded-xl p-8 hover:shadow-xl hover:border-accent/50 transition-all duration-300 transform hover:-translate-y-1 animate-in-delay-${index % 3}`}
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 scroll-fade-in">
        <div className="mb-12 animate-in">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Stay organized with our interactive academic calendar showing
            holidays, working days, and important events
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 animate-in">
            ...
            <p className="text-gray-600 text-lg leading-relaxed max-w-2xl">
              Four comprehensive engineering programs designed to build
          ...
          <div className="space-y-8">
            {programs.map((program, programIndex) => (
              <div
                key={program.id}
                className={`group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-xl hover:border-accent/50 transition-all duration-300 transform hover:-translate-y-1 animate-in-delay-${programIndex % 3}`}
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 scroll-fade-in">
        <div className="mb-12 animate-in">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Clear eligibility criteria and streamlined application process for
